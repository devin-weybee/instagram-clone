...
const Login = () => {
  ...
  return (
    <div className="bg-black h-screen w-full flex justify-center items-center gap-10">
      <div className="hidden md:w-4/12 md:flex justify-center">
        <img
      ...
      <div className="w-6/12 flex flex-col items-center  xl:w-4/12">
        <img className="w-full md:w-4/12 mb-10" src={INSTA_TEXT_LOGO} alt="" />
        <form
          action=""
          className="flex flex-col gap-2 md:w-7/12"
